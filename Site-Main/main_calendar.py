...
<head>
<meta charset="UTF-8">
<title>⚡ Travel Agent Engineering Control Center</title>
...
<div class="header">
    <div class="title">⚡ Travel Assistant Agent</div>
    <div class="controls">
...
<div class="container">
    ...
    <div class="panel">
        <div class="panel-header">
            ...
            <button onclick="reloadFrame('frame-8086')">↻</button>
        </div>
        <iframe id="frame-8086" src="localhost:8086"></iframe>
    </div>
...
function checkHealth() {
    agents.forEach(agent => {
        ...
        fetch(`localhost:${agent.port}/`, { mode: "no-cors" })
            .then(() => {
